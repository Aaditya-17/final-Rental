...
const RentEquipment = () => {
  ...
  return (
    <div className="max-w-5xl mt-10 mt-20 mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg flex flex-col md:flex-row">
      {/* Left Side - Images */}
      ...
      <div className="w-full md:w-1/2 md:pl-6 mt-6 md:mt-3">
        ...
        {/* Booking Form */}
        <div className="mt-38">
          <h3 className="text-lg font-bold text-white">{t("booking_form")}</h3>
          ...
          <label className="block text-white dark:text-white mt-4">
            {t("end_date")}
          </label>
          <input
            type="date"
